...
class updateUserData(serializers.Serializer):
...
class updateUserCredentials(serializers.Serializer):
    id = serializers.CharField(max_length = 8)
    usuario = serializers.CharField(max_length = 16)
    claveNew = serializers.CharField(max_length = 64)
    claveOld = serializers.CharField(max_length = 64)
