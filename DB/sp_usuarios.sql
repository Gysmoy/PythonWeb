...
GO
    ...
    CREATE PROCEDURE USUARIOS_CREATE @usuario VARCHAR(16),
    @correo VARCHAR(320),
    @clave CHAR(64),
    @dni CHAR(8),
    @apePater VARCHAR(15),
    ...
    @sexo CHAR(1),
    @fec_nac DATE,
    @id_idioma CHAR(8) AS BEGIN DECLARE @id CHAR(8)
SELECT
    @id = 'USR' + RIGHT('00000' + LTRIM(STR(COUNT(*) + 1)), 5)
FROM
    USUARIOS
INSERT INTO
    USUARIOS
...
GO
    ...
    CREATE PROCEDURE USUARIOS_READ_ALL AS
SELECT
    *
FROM
    USUARIOS
GO
    ...
    CREATE PROCEDURE USUARIOS_READ_ACTIVES AS
SELECT
    *
FROM
    USUARIOS
...
GO
    ...
    CREATE PROCEDURE USUARIOS_READ_INACTIVES AS
SELECT
    *
FROM
    USUARIOS
...
GO
    ...
    CREATE PROCEDURE USUARIOS_READ_ONE @id CHAR(8) AS
SELECT
    *
FROM
    USUARIOS
...
GO
    ...
    CREATE PROCEDURE USUARIOS_READ_USERNAME_PASSWORD @username CHAR(320),
    @password CHAR(64) AS
SELECT
    id,
    usuario,
...
GO
    ...
    CREATE PROCEDURE USUARIOS_SEARCH @search VARCHAR(50) AS
SELECT
    *
FROM
    USUARIOS
WHERE
    ...
    OR correo LIKE (CONCAT('%', @search, '%'))
    OR clave LIKE (CONCAT('%', @search, '%'))
    OR dni LIKE (CONCAT('%', @search, '%'))
    OR apePater LIKE (CONCAT('%', @search, '%'))
...
GO
    ...
    CREATE PROCEDURE USUARIOS_CHANGE_STATUS @id CHAR(8) AS DECLARE @estado BIT
SELECT
    @estado = estado
from
    USUARIOS
